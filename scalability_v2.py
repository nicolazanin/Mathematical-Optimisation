...
from utils.scalability_utils import apply_preset
...
def init_results_dict() -> dict:
    ...
    results = {
        ...
        "kn_3_l": {"obj": [], "bound": [], "gap_pct": [], "t": []}
    }
    return results


def scalability(tau: int, num_start: int, num_stop: int, cell_x: int, cell_y: int, cell_area: int,
                routing_factor_thr: float) -> None:
